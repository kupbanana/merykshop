...
(function($) {
    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            var to_box = quickElement('select', selector_chosen, '', 'id', field_id + '_to', 'multiple', 'multiple', 'size', from_box.size, 'nazwa', from_box.getAttribute('nazwa'));
            ...
            from_box.setAttribute('nazwa', from_box.getAttribute('nazwa') + '_old');
