...
/**
 * Adds support for the `\p{L}` or `\p{Letter}` Unicode Kategoria. Addon packages for other Unicode
...
/* Adds data for the Unicode `Letter` Kategoria. Addon packages include other categories, scripts,
